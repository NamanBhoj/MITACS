...
namespace SilverTau.Utilities.Sample
{
    public class OBJController : MonoBehaviour
    {
        ...
        [Tooltip("The path to the .mtl file you would like to import into the scene.")]
        [SerializeField] private string importPathmtl;
        ...
        private void Import()
        {
            ...
            Debug.Log("path : " + importPath);
             importPath = Application.persistentDataPath + "/House_Export1.obj";
             importPathmtl = Application.persistentDataPath + "/House_Export1.mtl";
            _lastImportModel = OBJUtility.Import(importPath, importPathmtl, shader);
            Debug.Log("does not come here");
